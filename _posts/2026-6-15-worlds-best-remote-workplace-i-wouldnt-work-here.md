---
title: This Is the World's Best Remote Workplace. I Wouldn't Work Here.
description: When you have great culture but questionable product
image: "/images/2026-6-15-the-best-remote-workplace-that-i-dont-want-to-work-at/levels-health-post-fi.jpg"
tags: [Building]
---
...
![YouTube video thumbnail for David Perell's interview with Sam Corcos titled "How Writing Helped This CEO Build a $300m+ Company"]({{site.baseurl}}/images/2026-6-15-the-best-remote-workplace-that-i-dont-want-to-work-at/levels-sam-corcos-david-perell-how-i-write-thumbnail.jpg "How Writing Helped This CEO Build a $300m+ Company - Sam Corcos")

Writing, and building a company? My two favorite topics? Okay, I'm sold on the click. Let's see what this is about.

I munched through [the 1.5+ hour podcast episode](https://youtu.be/IM6P_LB6W80?si=I7HI4dtxTpqzF_z0) in one sitting.

Something about Sam sitting cross-legged in that chair like a monk who's given up worldly pleasures and talking about [Levels' culture](https://levelshealth.notion.site/Culture-Handbook-f73041fd82c4408680ad075d6c5b34f3) and values enamored me. The highlights: lots and lots and lots of writing, long-ass memos, async-first communication, public townhalls, and "treating people like adults." After watching the podcast, I read [The Generalist's essay covering the company](https://www.generalist.com/p/levels-a-cultural-anomaly). It's paywalled now, but if memory serves me right, it dove deeper into why Levels exists: to solve the metabolic health crisis in the US, how the idea for the product and the company was conceived: after self-experimentation by one of the co-founders and a transformative and soul-searching road trip by another, and the backgrounds (and quirks) of some of the team members.

![The Sam Corcos starter pack, image courtesy of The Generalist]({{site.baseurl}}/images/2026-6-15-the-best-remote-workplace-that-i-dont-want-to-work-at/sam-corcos-starter-pack.jpg "The Sam Corcos Starter Pack")*Those are glasses with pads stuck on both sides to force you to stay focused on what's in front: your work. Yeah. I know.*
...
![A person wearing a continuous glucose monitor on their upper arm while checking their phone]({{site.baseurl}}/images/2026-6-15-the-best-remote-workplace-that-i-dont-want-to-work-at/cgm-on-arm-sweet-life-unsplash.jpg "Continuous glucose monitor worn on the arm")*A person wearing a continuous glucose monitor on their upper arm. Photo by [Sweet Life](https://unsplash.com/@sweetlifediabetes?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText) on [Unsplash](https://unsplash.com/photos/a-person-scanning-blood-glucose-with-a-flash-glucose-monitor-x0dK2Tj7oDA?utm_source=unsplash&utm_medium=referral&utm_content=creditCopyText).*
...
![The Levels founding team: Sam Corcos, Josh Clemente, Casey Means, David Flinner, and Andrew Conner]({{site.baseurl}}/images/2026-6-15-the-best-remote-workplace-that-i-dont-want-to-work-at/Levels%20Founding%20team.png "Levels founding team")*Levels founding team. Image courtesy: [Levels careers page](https://levelshealth.notion.site/Careers-at-Levels-3616891ed02d4c0787fd64227f9bc57a)*

![Levels advisors including Casey Means, Robert Lustig, Ben Bikman, Sara Gottfried, David Perlmutter, Dom D'Agostino, and Terry Wahls]({{site.baseurl}}/images/2026-6-15-the-best-remote-workplace-that-i-dont-want-to-work-at/Levels%20Advisors%20Mar%202025.png "Levels advisors")*Levels advisors. Image courtesy: [Levels careers page](https://levelshealth.notion.site/Careers-at-Levels-3616891ed02d4c0787fd64227f9bc57a)*
...
And this is where my problems with what this company is building begin. Levels measures [several different biomarkers](https://www.levels.com/what-we-measure), and while I generally agree with the saying "what gets measured gets managed," my question is: do you really need to see all of these measurements to make healthier food choices? You already know what you should and shouldn't eat. Why would you want metrics bombarded at you day in and day out? Levels has a 'biological age' marker. I can't help but imagine some user out there, looking at their phone screen, hoping they grew just a bit younger today, and worse, actually actively trying to do it. Do you see how sad that is? That's the risk you run when you implement gamification principles in places where they have no business.

![Levels app screenshot showing the Biological Age biomarker card]({{site.baseurl}}/images/2026-6-15-the-best-remote-workplace-that-i-dont-want-to-work-at/biological-age-marker-levels.jpg "Levels Biological Age marker")

The biohackers have gone overboard, and it's not just a personal opinion. Doctors and dietitians have warned that for people prone to anxiety or with a history of disordered eating, the real-time feedback loop of a CGM [can make things worse instead of better](https://www.mentalhealthdietitians.com/glucose-monitoring-for-non-diabetics-a-dangerous-trend/). There's even a name for having an unhealthy obsession with eating correctly: [*orthorexia*](https://therapist.com/behaviors/orthorexia/). In the hands of the wrong person, a CGM is basically an accelerant for orthorexia. And [a lot of the people wearing them](https://www.statnews.com/2025/05/27/biohackers-longevity-continuous-glucose-monitoring-programming-body/) are exactly the wrong person.
